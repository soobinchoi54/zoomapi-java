...
public class MeetingComponent extends BaseComponent{
    ...
    public JSONObject listMeetings(Map<String,String> params) throws IOException {
    ...
    public JSONObject createMeeting(Map<String,String> params) throws IOException {
    ...
    public JSONObject getMeeting(Map<String,String> params) throws IOException {
        String[] keys = new String[] {"meetingId"};
        Util.requireKeys(params, keys);
        return this.getRequest(String.format("/meetings/%s", params.get("meetingId")), params);
    }

    public JSONObject updateMeeting(Map<String,String> params) throws IOException, URISyntaxException {
        String[] keys = new String[] {"meetingId", "start_time"};
        Util.requireKeys(params, keys);
        return this.patchRequest(String.format("/meetings/%s", params.get("meetingId")), params);
    }

    public JSONObject deleteMeeting(Map<String,String> params) throws IOException {
        String[] keys = new String[] {"meetingId"};
        Util.requireKeys(params, keys);
